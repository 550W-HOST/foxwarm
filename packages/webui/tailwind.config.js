...
const foxwarmColors = Object.fromEntries([
  ...
  'success-surface', 'success-surface-strong', 'success-border', 'tool', 'tool-surface',
  'tool-surface-strong', 'tool-border', 'warning', 'warning-surface',
  ...
  'diff-added-surface-strong', 'diff-added-text', 'diff-removed-surface', 'diff-removed-surface-strong', 'diff-removed-text',
  'syntax-comment', 'syntax-string', 'syntax-number', 'syntax-keyword', 'syntax-literal',
  'syntax-heading', 'syntax-tag', 'syntax-attribute', 'syntax-property',
