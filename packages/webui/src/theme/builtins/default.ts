...
const defaultLight = variant({
  colors: {
    ...
    successSurfaceStrong: '#dcfce7', successBorder: '#86efac', tool: '#15803d', toolSurface: '#f0fdf4', toolSurfaceStrong: '#dcfce7', toolBorder: '#86efac', warning: '#b45309', warningSurface: '#fffbeb',
    ...
    diffAddedSurface: '#dcfce7', diffAddedSurfaceStrong: '#bbf7d0', diffAddedText: '#3b82f6', diffRemovedText: '#b45309', syntaxComment: '#6b7280', syntaxString: '#15803d', syntaxNumber: '#3b82f6', syntaxKeyword: '#7e22ce', syntaxLiteral: '#2563eb', syntaxHeading: '#111827', syntaxTag: '#dc2626', syntaxAttribute: '#b45309', syntaxProperty: '#2563eb', diffRemovedSurface: '#fee2e2',
...
const defaultDark = variant({
  colors: {
    ...
    successSurfaceStrong: '#14532d', successBorder: '#166534', tool: '#4ade80', toolSurface: '#052e16', toolSurfaceStrong: '#14532d', toolBorder: '#166534', warning: '#fbbf24', warningSurface: '#451a03',
    ...
    diffAddedSurface: '#052e16', diffAddedSurfaceStrong: '#14532d', diffAddedText: '#60a5fa', diffRemovedText: '#fbbf24', syntaxComment: '#9ca3af', syntaxString: '#4ade80', syntaxNumber: '#60a5fa', syntaxKeyword: '#c084fc', syntaxLiteral: '#93c5fd', syntaxHeading: '#f3f4f6', syntaxTag: '#f87171', syntaxAttribute: '#fbbf24', syntaxProperty: '#93c5fd', diffRemovedSurface: '#450a0a',
