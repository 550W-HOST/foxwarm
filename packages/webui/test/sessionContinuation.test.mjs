...
const cases = [
  ...
  { name: 'zero-timeout wait is still parameterized rather than bare', messages: [callMessage('wait-zero', 'wait', { timeoutSeconds: 0 }), toolMessage('wait-zero', 'wait')], incomplete: true },
