...
test('setup status hydrates virtual targets and round-trips through structured request and YAML', () => {
  ...
  for (const forbidden of ['models', 'model', 'baseUrl', 'apiKey', 'requestCompression', 'extraFields', 'extraHeaders', 'webSearch', 'imageGeneration', 'contextLimit', 'historyReasoningField', 'asyncCompact']) {
