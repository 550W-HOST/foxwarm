...
def _scan_file_content(
    ...
    # This scanner deliberately contains regex examples for eval(), exec(),
    # __import__(), and secret-like text. Do not report the scanner's own
    # pattern definitions as issues when validating a skill that bundles it.
    if relative_path == "scripts/security_scan.py":
        return issues
