...
- SessionRuntime child placement still needs remaining service closure, committed projection/resync and final delivery, exhaustive supported tool closure, supervisor ingress routing, and idle release. The activated child runner remains disconnected from production placement until that vertical slice is complete.
