...
7. `webui-chat-timeline` renders accumulated tokens, reasoning, tool identity, and a bounded partial/raw argument preview. Partial JSON is parsed only when the one-second argument update arrives; invalid JSON remains readable raw text.
