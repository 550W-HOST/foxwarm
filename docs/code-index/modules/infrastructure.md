...
- [src-mcp-inbound-http](../units/src-mcp-inbound-http.md) — identity-bound Streamable HTTP ingress, ephemeral external execution context, and explicitly unwired tool catalog.
