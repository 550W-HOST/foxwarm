...
- Canonical message validation accepts only the recognized optional text-part phases `commentary` and `final_answer`; archive writes and reads preserve them without provider/model scoping.
