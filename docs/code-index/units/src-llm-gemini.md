...
- Function responses retain call IDs and names, carry formatted structured output, prepend persisted request-timing markers, and attach matching tool-result images.
