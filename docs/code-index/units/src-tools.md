...
| `executeResolvedTool` | Authorizes an outer unified `call_tool` identity plus its independent concrete target, then dispatches through local, Node, or MCP owners |
