...
- The native message scroller owns document-level horizontal containment; shrinkable inner chat/timeline boundaries remain overflow-visible so intentional thread gutters and usage-badge paint survive. Tables/output retain intentional inner scrolling. Canonical contract: [D-webui-timeline-overflow-boundary](./webui-chat-timeline.md#d-webui-timeline-overflow-boundary).
