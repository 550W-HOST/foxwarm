...
| `WeWorkWebhookChannel.maybeAggregateStreamMessage(userId, text, options)` | late | Applies automatic turn text or progress to the latest active card in the attachment conversation |
